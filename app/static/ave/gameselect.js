function titleFromAVE(){return "<>   @@@@@  ADVENTURE!        ^^    ^ VILLAINY!         ====== EXCITEMENT!   %v%\n<>  @@    @ ADVENTURE!        ^^    ^ VILLAINY!         ==     EXCITEMENT!   %v%\n<>  @@@@@@@ ADVENTURE!         ^^   ^ VILLAINY!         =====  EXCITEMENT!   %v%\n<>  @@    @ ADVENTURE!          ^^  ^ VILLAINY!         ==     EXCITEMENT!   %v%\n<>  @@    @ ADVENTURE!           ^^^^ VILLAINY!         ====== EXCITEMENT!   %v%\n<>                                                                   version %v%\nAVE: Adventure! Villainy! Excitement!\n<-A text-based game engine written by Gin Grasso & Matthew Scroggs.\n<-AVEgame.co.uk\n<-github.com/AVEgame/AVE\n"}
function creditsFromAVE(){return "<>        @@@@@@@@@               ^^^   ^^^              ============      \n<>       @@@@@    @@            ^ ^=^^^^^=^ ^           ==          ==     \n<>       @@@       @            ^           ^           = ====  ==== =     \n<>       @  ^   ^  @             ^^  ^^^  ^^            = = @==== @= =     \n<>       @    ^    @              ^^^   ^^^               ====  ====       \n<>                                   ^^^                                   \n<>     Matthew Scroggs            Gin Grasso             Alex Bolton       \n<>       (\"Scroggs\")           (\"Spinny Ginny\")            (\"Bolt\")        \n<>   Programming & Story     Programming & Story       He came up with     \n<>                                                      the name AVE.      \n<>        @@@@@@@@@              ^^^^^^^^^^^                               \n<>      @@@       @@@           ^^         ^^                              \n<>     @@           @@          ^ ^^^^ ^^^^ ^                              \n<>     @@  @@@ @@@  @@            ^= ^^^= ^                                \n<>     @@  @^@@@^@  @@            ^^^^ ^^^^          @@@@@  ^^    ^ ====== \n<>     @@  @@@ @@@  @@                              @@    @ ^^    ^ ==     \n<>     @Alison Clarke@          Adam Townsend       @@@@@@@  ^^   ^ =====  \n<>     @@  (\"Alan\") @@            (\"Jigsaw\")        @@    @   ^^  ^ ==     \n<>     @@   Story   @@              Story           @@    @    ^^^^ ====== \n"}
function version(){return version_str}
...
function showGameTitle(id){
    ...
    out += "<div id='menu'>"
    out += "<div class='menuitem' onclick='loadGame(\""+gameList[id]["filename"]+"\")'>Play game</div>"
    out += "<div class='menuitem' onclick='showMainTitle()'>Back to main menu</div>"
    out += "</div>"
    document.getElementById("main").innerHTML = out
}
